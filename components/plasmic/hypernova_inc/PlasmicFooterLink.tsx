...
import sty from "./PlasmicFooterLink.module.css"; // plasmic-import: dt2Xk7nKXE4v/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          ...
          value: args.footerLinkText,
          className: classNames(sty.slotTargetFooterLinkText)
        })}
      </PlasmicLink__>
    </div>
