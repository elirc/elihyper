...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: sriN2je8x4nf/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: GbLsoTKpa9JF/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: uoRqTs8_qEKv/icon
...
export type PlasmicCheckbox__OverridesType = {
  timelineCheckbox?: Flex__<typeof BaseCheckbox>;
  freeBox?: Flex__<"div">;
};
...
function PlasmicCheckbox__RenderFunc(props: {
  ...
  const stateSpecs: Parameters<typeof useDollarState>[0] = React.useMemo(
    () => [
      {
        path: "timelineCheckbox.isSelected",
        type: "writable",
  ...
  return (
    <BaseCheckbox
      data-plasmic-name={"timelineCheckbox"}
      data-plasmic-override={overrides.timelineCheckbox}
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__szfhc)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg__wgsAf)}
            role={"img"}
          />
        ) : null}
      </div>
...
const PlasmicDescendants = {
  timelineCheckbox: ["timelineCheckbox", "freeBox"],
  freeBox: ["freeBox"]
} as const;
...
type NodeDefaultElementType = {
  timelineCheckbox: typeof BaseCheckbox;
  freeBox: "div";
};
...
export const PlasmicCheckbox = Object.assign(
  ...
  makeNodeComponent("timelineCheckbox"),
  {
