...
import Label from "../../Label"; // plasmic-import: cgj4pju7M3jW/component
import TextInput from "../../TextInput"; // plasmic-import: 6Hxcv-E2dfj9/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: xn09Q9_dprvy/component
import Description from "../../Description"; // plasmic-import: Dorxjv_bLja7/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: dDAwSpAq4Bv9/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox___3Xipc, {
          [sty.freeBoxiconEnd___3XipCeY4I2]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart___3XipChFo3U]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine___3XipcrkDJ]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__zXshC, {
            [sty.freeBoxiconStart__zXshChFo3U]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__zXshCrkDJ]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__cPum)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__vp1Lh, {
            [sty.freeBoxiconEnd__vp1LheY4I2]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__vp1LhhFo3U]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__mzvWs)}
                role={"img"}
              />
            ),
