...
import sty from "./PlasmicFeaturesCard.module.css"; // plasmic-import: WPZJuBWNQ9vc/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Icon56Icon
              className={classNames(projectcss.all, sty.svg__utJr1)}
              role={"img"}
            />
          ),
...
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    Omit<PlasmicFeaturesCard__VariantsArgs, ReservedPropsType> &
