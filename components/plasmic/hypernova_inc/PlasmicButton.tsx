...
import sty from "./PlasmicButton.module.css"; // plasmic-import: g6-GMD9fVzpv/css
...
export type PlasmicButton__VariantMembers = {
  ...
  type: "bordered" | "simple" | "simpleTransparent";
...
export type PlasmicButton__VariantsArgs = {
  ...
  >;
  type?: SingleChoiceArg<"bordered" | "simple" | "simpleTransparent">;
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.roottype_bordered_color_errorDestructive]:
            ...
            hasVariant($state, "type", "bordered"),
          [sty.roottype_simpleTransparent]: hasVariant(
            $state,
            "type",
            "simpleTransparent"
          ),
          [sty.roottype_simple]: hasVariant($state, "type", "simple")
        }
      )}
      href={args.linkTo}
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__uVFn, {
          [sty.freeBoxcolor_neutral__uVFnmBznl]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__uVFnSga3AT4Lc5]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxroundedFull__uVFnXEaOe]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__uVFnlAm5M]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__uVFnCzpLw]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__uVFnz09Eh]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__uVFnPf6Kh]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__uVFnt4Lc5]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_simpleTransparent__uVFnxBkYc]: hasVariant(
            $state,
            "type",
            "simpleTransparent"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___49EgS, {
            [sty.freeBoxcolor_neutral___49EgSmBznl]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart___49EgSgo8Sr]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge___49EgSlAm5M]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___49EgSz09Eh]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___49EgSpf6Kh]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered___49EgSt4Lc5]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__diuhj)}
                role={"img"}
              />
            ),
        ...
        {renderPlasmicSlot({
          ...
          className: classNames(sty.slotTargetLabel, {
            ...
            [sty.slotTargetLabeltype_bordered_color_errorDestructive]:
              hasVariant($state, "color", "errorDestructive") &&
              hasVariant($state, "type", "bordered"),
            [sty.slotTargetLabeltype_simpleTransparent]: hasVariant(
              $state,
              "type",
              "simpleTransparent"
            )
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox___9IoI, {
            [sty.freeBoxiconEnd___9IoI4SqH3]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge___9IoILAm5M]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large___9IoIZ09Eh]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small___9IoIPf6Kh]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__gzmHf)}
                role={"img"}
              />
            ),
