...
import { PlasmicHamburgerMenu, DefaultHamburgerMenuProps } from './plasmic/hypernova_inc/PlasmicHamburgerMenu'
...
function HamburgerMenu_(props: HamburgerMenuProps, ref: HTMLElementRefOf<'button'>) {
